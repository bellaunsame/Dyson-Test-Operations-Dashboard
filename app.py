...
This email was auto-generated by the Operations Dashboard."""
    ...
    smtp_server = os.getenv('EMAIL_SERVER') or os.getenv('MAIL_SERVER')
    smtp_port = int(os.getenv('EMAIL_PORT') or os.getenv('MAIL_PORT', 587))
    ...
    email_sender = os.getenv('EMAIL_FROM') or os.getenv('MAIL_DEFAULT_SENDER') or os.getenv('MAIL_SENDER') or email_user

    use_tls = str(smtp_tls).lower() in ('true', '1', 'yes')
    use_ssl = str(smtp_ssl).lower() in ('true', '1', 'yes')
